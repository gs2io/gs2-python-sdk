...
from inbox import Gs2InboxRestClient, GlobalMessageMaster, request
from inbox.domain.cache.global_message_master import GlobalMessageMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeGlobalMessageMastersIterator:
    ...
    _last: bool
    _result: List[GlobalMessageMaster]
    ...
    def _load(
        ...
        r = self._client.describe_global_message_masters(
        ...
        for item in r.items:
            self._global_message_master_cache.update(item)
    ...
    def __next__(self) -> GlobalMessageMaster:
