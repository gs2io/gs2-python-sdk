...
from money import Gs2MoneyRestClient, Wallet, request
from money.domain.cache.wallet import WalletDomainCache
from core.domain.access_token import AccessToken


class DescribeWalletsByUserIdIterator:
    ...
    def _load(
        ...
        r = self._client.describe_wallets_by_user_id(
        ...
        for item in r.items:
            self._wallet_cache.update(item)
