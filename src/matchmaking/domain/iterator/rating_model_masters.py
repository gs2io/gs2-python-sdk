...
from matchmaking import Gs2MatchmakingRestClient, RatingModelMaster, request
from matchmaking.domain.cache.rating_model_master import RatingModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeRatingModelMastersIterator:
    ...
    _last: bool
    _result: List[RatingModelMaster]

    fetch_size: Optional[int]

    def __init__(
        self,
        rating_model_master_cache: RatingModelMasterDomainCache,
        client: Gs2MatchmakingRestClient,
        namespace_name: str,
    ):
        self._rating_model_master_cache = rating_model_master_cache
        self._client = client
    ...
    def _load(
        ...
        r = self._client.describe_rating_model_masters(
        ...
        for item in r.items:
            self._rating_model_master_cache.update(item)
    ...
    def __next__(self) -> RatingModelMaster:
