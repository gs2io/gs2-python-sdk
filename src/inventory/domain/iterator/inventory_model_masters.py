...
from inventory import Gs2InventoryRestClient, InventoryModelMaster, request
from inventory.domain.cache.inventory_model_master import InventoryModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeInventoryModelMastersIterator:
    ...
    _last: bool
    _result: List[InventoryModelMaster]
    ...
    def _load(
        ...
        r = self._client.describe_inventory_model_masters(
        ...
        for item in r.items:
            self._inventory_model_master_cache.update(item)
    ...
    def __next__(self) -> InventoryModelMaster:
