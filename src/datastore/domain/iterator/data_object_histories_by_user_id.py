...
from datastore import Gs2DatastoreRestClient, DataObjectHistory, request
from datastore.domain.cache.data_object_history import DataObjectHistoryDomainCache
from core.domain.access_token import AccessToken


class DescribeDataObjectHistoriesByUserIdIterator:
    ...
    _last: bool
    _result: List[DataObjectHistory]
    ...
    def __next__(self) -> DataObjectHistory:
