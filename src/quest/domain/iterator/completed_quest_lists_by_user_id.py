...
from quest import Gs2QuestRestClient, CompletedQuestList, request
from quest.domain.cache.completed_quest_list import CompletedQuestListDomainCache
from core.domain.access_token import AccessToken


class DescribeCompletedQuestListsByUserIdIterator:
    ...
    _last: bool
    _result: List[CompletedQuestList]
    ...
    def _load(
        ...
        r = self._client.describe_completed_quest_lists_by_user_id(
        ...
        for item in r.items:
            self._completed_quest_list_cache.update(item)
    ...
    def __next__(self) -> CompletedQuestList:
