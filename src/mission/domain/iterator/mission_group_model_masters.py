...
from mission import Gs2MissionRestClient, MissionGroupModelMaster, request
from mission.domain.cache.mission_group_model_master import MissionGroupModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeMissionGroupModelMastersIterator:
    ...
    _last: bool
    _result: List[MissionGroupModelMaster]
    ...
    def _load(
        ...
        r = self._client.describe_mission_group_model_masters(
        ...
        for item in r.items:
            self._mission_group_model_master_cache.update(item)
    ...
    def __next__(self) -> MissionGroupModelMaster:
