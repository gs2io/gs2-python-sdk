...
from mission import Gs2MissionRestClient, MissionTaskModel, request
from mission.domain.cache.mission_task_model import MissionTaskModelDomainCache
from core.domain.access_token import AccessToken


class DescribeMissionTaskModelsIterator:
    ...
    def _load(
        ...
        r = self._client.describe_mission_task_models(
        ...
        for item in r.items:
            self._mission_task_model_cache.update(item)
    ...
    def __next__(self) -> MissionTaskModel:
