...
from dictionary import Gs2DictionaryRestClient, Entry, request
from dictionary.domain.cache.entry import EntryDomainCache
from core.domain.access_token import AccessToken


class DescribeEntriesByUserIdIterator:
    ...
    def _load(
        ...
        r = self._client.describe_entries_by_user_id(
