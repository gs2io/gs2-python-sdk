...
from experience import Gs2ExperienceRestClient, ExperienceModelMaster, request
from experience.domain.cache.experience_model_master import ExperienceModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeExperienceModelMastersIterator:
    ...
    _last: bool
    _result: List[ExperienceModelMaster]
    ...
    def _load(
        ...
        r = self._client.describe_experience_model_masters(
        ...
        for item in r.items:
            self._experience_model_master_cache.update(item)
    ...
    def __next__(self) -> ExperienceModelMaster:
