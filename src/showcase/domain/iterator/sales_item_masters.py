...
from showcase import Gs2ShowcaseRestClient, SalesItemMaster, request
from showcase.domain.cache.sales_item_master import SalesItemMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeSalesItemMastersIterator:
    ...
    def _load(
        ...
        r = self._client.describe_sales_item_masters(
        ...
        for item in r.items:
            self._sales_item_master_cache.update(item)
    ...
    def __next__(self) -> SalesItemMaster:
