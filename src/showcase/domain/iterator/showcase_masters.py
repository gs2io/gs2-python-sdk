...
from showcase import Gs2ShowcaseRestClient, ShowcaseMaster, request
from showcase.domain.cache.showcase_master import ShowcaseMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeShowcaseMastersIterator:
    ...
    def _load(
        ...
        r = self._client.describe_showcase_masters(
        ...
        for item in r.items:
            self._showcase_master_cache.update(item)
    ...
    def __next__(self) -> ShowcaseMaster:
