...
from schedule import Gs2ScheduleRestClient, EventMaster, request
from schedule.domain.cache.event_master import EventMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeEventMastersIterator:
    ...
    def _load(
        ...
        r = self._client.describe_event_masters(
        ...
        for item in r.items:
            self._event_master_cache.update(item)
