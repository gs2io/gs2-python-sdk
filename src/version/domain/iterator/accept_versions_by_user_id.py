...
from version import Gs2VersionRestClient, AcceptVersion, request
from version.domain.cache.accept_version import AcceptVersionDomainCache
from core.domain.access_token import AccessToken


class DescribeAcceptVersionsByUserIdIterator:
    ...
    def _load(
        ...
        r = self._client.describe_accept_versions_by_user_id(
        ...
        for item in r.items:
            self._accept_version_cache.update(item)
    ...
    def __next__(self) -> AcceptVersion:
