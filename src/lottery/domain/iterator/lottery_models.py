...
from lottery import Gs2LotteryRestClient, LotteryModel, request
from lottery.domain.cache.lottery_model import LotteryModelDomainCache
from core.domain.access_token import AccessToken


class DescribeLotteryModelsIterator:
    ...
    def __next__(self) -> LotteryModel:
