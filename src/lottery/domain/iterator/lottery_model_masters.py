...
from lottery import Gs2LotteryRestClient, LotteryModelMaster, request
from lottery.domain.cache.lottery_model_master import LotteryModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeLotteryModelMastersIterator:
    ...
    _last: bool
    _result: List[LotteryModelMaster]

    fetch_size: Optional[int]

    def __init__(
        self,
        lottery_model_master_cache: LotteryModelMasterDomainCache,
        client: Gs2LotteryRestClient,
        namespace_name: str,
    ):
        self._lottery_model_master_cache = lottery_model_master_cache
        self._client = client
    ...
    def _load(
        ...
        r = self._client.describe_lottery_model_masters(
        ...
        for item in r.items:
            self._lottery_model_master_cache.update(item)
    ...
    def __next__(self) -> LotteryModelMaster:
