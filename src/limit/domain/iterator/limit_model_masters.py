...
from limit import Gs2LimitRestClient, LimitModelMaster, request
from limit.domain.cache.limit_model_master import LimitModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeLimitModelMastersIterator:
    ...
    def _load(
        ...
        r = self._client.describe_limit_model_masters(
        ...
        for item in r.items:
            self._limit_model_master_cache.update(item)
    ...
    def __next__(self) -> LimitModelMaster:
