...
from formation import Gs2FormationRestClient, MoldModelMaster, request
from formation.domain.cache.mold_model_master import MoldModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeMoldModelMastersIterator:
    ...
    def _load(
        ...
        r = self._client.describe_mold_model_masters(
        ...
        for item in r.items:
            self._mold_model_master_cache.update(item)
    ...
    def __next__(self) -> MoldModelMaster:
