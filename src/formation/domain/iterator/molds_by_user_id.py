...
from formation import Gs2FormationRestClient, Mold, request
from formation.domain.cache.mold import MoldDomainCache
from core.domain.access_token import AccessToken


class DescribeMoldsByUserIdIterator:
    ...
    def _load(
        ...
        r = self._client.describe_molds_by_user_id(
