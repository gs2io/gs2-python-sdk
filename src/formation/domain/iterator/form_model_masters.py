...
from formation import Gs2FormationRestClient, FormModelMaster, request
from formation.domain.cache.form_model_master import FormModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeFormModelMastersIterator:
    ...
    def _load(
        ...
        r = self._client.describe_form_model_masters(
        ...
        for item in r.items:
            self._form_model_master_cache.update(item)
    ...
    def __next__(self) -> FormModelMaster:
