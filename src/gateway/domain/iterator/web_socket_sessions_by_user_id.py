...
from gateway import Gs2GatewayRestClient, WebSocketSession, request
from gateway.domain.cache.web_socket_session import WebSocketSessionDomainCache
from core.domain.access_token import AccessToken


class DescribeWebSocketSessionsByUserIdIterator:
    ...
    def _load(
        ...
        r = self._client.describe_web_socket_sessions_by_user_id(
        ...
        for item in r.items:
            self._web_socket_session_cache.update(item)
    ...
    def __next__(self) -> WebSocketSession:
