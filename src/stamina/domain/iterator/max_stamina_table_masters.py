...
from stamina import Gs2StaminaRestClient, MaxStaminaTableMaster, request
from stamina.domain.cache.max_stamina_table_master import MaxStaminaTableMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeMaxStaminaTableMastersIterator:
    ...
    _last: bool
    _result: List[MaxStaminaTableMaster]
    ...
    def _load(
        ...
        r = self._client.describe_max_stamina_table_masters(
        ...
        for item in r.items:
            self._max_stamina_table_master_cache.update(item)
    ...
    def __next__(self) -> MaxStaminaTableMaster:
