...
from stamina import Gs2StaminaRestClient, Stamina, request
from stamina.domain.cache.stamina import StaminaDomainCache
from core.domain.access_token import AccessToken


class DescribeStaminasByUserIdIterator:
    ...
    def _load(
        ...
        r = self._client.describe_staminas_by_user_id(
        ...
        for item in r.items:
            self._stamina_cache.update(item)
