...
from ranking import Gs2RankingRestClient, CategoryModelMaster, request
from ranking.domain.cache.category_model_master import CategoryModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeCategoryModelMastersIterator:
    ...
    _last: bool
    _result: List[CategoryModelMaster]
    ...
    def _load(
        ...
        r = self._client.describe_category_model_masters(
        ...
        for item in r.items:
            self._category_model_master_cache.update(item)
    ...
    def __next__(self) -> CategoryModelMaster:
