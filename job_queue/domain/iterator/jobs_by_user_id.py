...
from job_queue import Gs2JobQueueRestClient, Job, request
from job_queue.domain.cache.job import JobDomainCache
from core.domain.access_token import AccessToken


class DescribeJobsByUserIdIterator:
    ...
    def _load(
        ...
        r = self._client.describe_jobs_by_user_id(
