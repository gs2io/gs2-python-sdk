...
from version import Gs2VersionRestClient, VersionModelMaster, request
from version.domain.cache.version_model_master import VersionModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeVersionModelMastersIterator:
    ...
    _last: bool
    _result: List[VersionModelMaster]
    ...
    def _load(
        ...
        r = self._client.describe_version_model_masters(
        ...
        for item in r.items:
            self._version_model_master_cache.update(item)
    ...
    def __next__(self) -> VersionModelMaster:
