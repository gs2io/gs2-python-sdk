...
from account import Gs2AccountRestClient, TakeOver, request
from account.domain.cache.take_over import TakeOverDomainCache
from core.domain.access_token import AccessToken


class DescribeTakeOversByUserIdIterator:
    ...
    def _load(
        ...
        r = self._client.describe_take_overs_by_user_id(
        ...
        for item in r.items:
            self._take_over_cache.update(item)
