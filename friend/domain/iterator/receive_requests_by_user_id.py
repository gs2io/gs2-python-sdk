...
from friend import Gs2FriendRestClient, FriendRequest, request
from friend.domain.cache.friend_request import FriendRequestDomainCache
from core.domain.access_token import AccessToken


class DescribeReceiveRequestsByUserIdIterator:
    ...
    _last: bool
    _result: List[FriendRequest]

    fetch_size: Optional[int]

    def __init__(
        self,
        friend_request_cache: FriendRequestDomainCache,
        client: Gs2FriendRestClient,
        namespace_name: str,
        user_id: str,
    ):
        self._friend_request_cache = friend_request_cache
        self._client = client
    ...
    def _load(
        ...
        r = self._client.describe_receive_requests_by_user_id(
        ...
        for item in r.items:
            self._friend_request_cache.update(item)
    ...
    def __next__(self) -> FriendRequest:
