...
from quest import Gs2QuestRestClient, QuestModelMaster, request
from quest.domain.cache.quest_model_master import QuestModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeQuestModelMastersIterator:
    ...
    def _load(
        ...
        r = self._client.describe_quest_model_masters(
        ...
        for item in r.items:
            self._quest_model_master_cache.update(item)
    ...
    def __next__(self) -> QuestModelMaster:
