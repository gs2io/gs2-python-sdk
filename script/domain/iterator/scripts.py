...
from script import Gs2ScriptRestClient, Script, request
from script.domain.cache.script import ScriptDomainCache
from core.domain.access_token import AccessToken


class DescribeScriptsIterator:
    ...
    def _load(
        ...
        r = self._client.describe_scripts(
        ...
        for item in r.items:
            self._script_cache.update(item)
