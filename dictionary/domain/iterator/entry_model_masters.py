...
from dictionary import Gs2DictionaryRestClient, EntryModelMaster, request
from dictionary.domain.cache.entry_model_master import EntryModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeEntryModelMastersIterator:
    ...
    def _load(
        ...
        r = self._client.describe_entry_model_masters(
        ...
        for item in r.items:
            self._entry_model_master_cache.update(item)
    ...
    def __next__(self) -> EntryModelMaster:
