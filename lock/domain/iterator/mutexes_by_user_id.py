...
from lock import Gs2LockRestClient, Mutex, request
from lock.domain.cache.mutex import MutexDomainCache
from core.domain.access_token import AccessToken


class DescribeMutexesByUserIdIterator:
    ...
    def _load(
        ...
        r = self._client.describe_mutexes_by_user_id(
