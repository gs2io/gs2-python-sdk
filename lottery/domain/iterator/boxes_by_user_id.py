...
from lottery import Gs2LotteryRestClient, Box, request
from lottery.domain.cache.box import BoxDomainCache
from core.domain.access_token import AccessToken


class DescribeBoxesByUserIdIterator:
    ...
    def _load(
        ...
        r = self._client.describe_boxes_by_user_id(
