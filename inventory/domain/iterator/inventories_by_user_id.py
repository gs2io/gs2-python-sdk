...
from inventory import Gs2InventoryRestClient, Inventory, request
from inventory.domain.cache.inventory import InventoryDomainCache
from core.domain.access_token import AccessToken


class DescribeInventoriesByUserIdIterator:
    ...
    def _load(
        ...
        r = self._client.describe_inventories_by_user_id(
        ...
        for item in r.items:
            self._inventory_cache.update(item)
