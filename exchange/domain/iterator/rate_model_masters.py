...
from exchange import Gs2ExchangeRestClient, RateModelMaster, request
from exchange.domain.cache.rate_model_master import RateModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeRateModelMastersIterator:
    ...
    def _load(
        ...
        r = self._client.describe_rate_model_masters(
        ...
        for item in r.items:
            self._rate_model_master_cache.update(item)
    ...
    def __next__(self) -> RateModelMaster:
