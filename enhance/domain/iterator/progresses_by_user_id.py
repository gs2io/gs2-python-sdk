...
from enhance import Gs2EnhanceRestClient, Progress, request
from enhance.domain.cache.progress import ProgressDomainCache
from core.domain.access_token import AccessToken


class DescribeProgressesByUserIdIterator:
    ...
    def _load(
        ...
        r = self._client.describe_progresses_by_user_id(
        ...
        for item in r.items:
            self._progress_cache.update(item)
