...
from experience import Gs2ExperienceRestClient, ThresholdMaster, request
from experience.domain.cache.threshold_master import ThresholdMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeThresholdMastersIterator:
    ...
    def _load(
        ...
        r = self._client.describe_threshold_masters(
        ...
        for item in r.items:
            self._threshold_master_cache.update(item)
    ...
    def __next__(self) -> ThresholdMaster:
