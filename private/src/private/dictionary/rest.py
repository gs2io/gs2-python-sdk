...
from dictionary.rest import Gs2DictionaryRestClient
from core.model import Gs2Constant
import private.dictionary.request as request_model
import private.dictionary.result as result_model


class Gs2DictionaryPrivateRestClient(Gs2DictionaryRestClient):
    ...
    def _describe_namespaces_by_owner_id(
        ...
        ) + "/system/{ownerId}/dictionary".format(
