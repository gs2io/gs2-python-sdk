...
from account.web_socket import Gs2AccountWebSocketClient
import private.account.request as request_model
import private.account.result as result_model


class Gs2AccountPrivateWebSocketClient(Gs2AccountWebSocketClient):
