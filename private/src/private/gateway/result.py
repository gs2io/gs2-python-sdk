...
class ConnectResult(Gs2Result):
    ...
    def __init__(
        ...
        super(ConnectResult, self).__init__()
    ...
    def __getitem__(self, key):
        ...
        if key in items.keys():
            return items[key]
        return super(ConnectResult, self).__getitem__(key)
...
class DisconnectResult(Gs2Result):
    """
    切断 のレスポンスモデル
    """
    ...
    def __init__(
        ...
        super(DisconnectResult, self).__init__()
    ...
    def __getitem__(self, key):
        ...
        if key in items.keys():
            return items[key]
        return super(DisconnectResult, self).__getitem__(key)
...
class SendNotificationByOwnerIdResult(Gs2Result):
    """
    オーナーIDを指定して通知を送信 のレスポンスモデル
    """
    ...
    def __init__(
        ...
        super(SendNotificationByOwnerIdResult, self).__init__()
        # 通知に使用したプロトコル
        self._protocol = response.get('protocol') if 'protocol' in response else None
    ...
    def __getitem__(self, key):
        ...
        if key in items.keys():
            return items[key]
        return super(SendNotificationByOwnerIdResult, self).__getitem__(key)
