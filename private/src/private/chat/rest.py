...
from chat.rest import Gs2ChatRestClient
from core.model import Gs2Constant
import private.chat.request as request_model
import private.chat.result as result_model


class Gs2ChatPrivateRestClient(Gs2ChatRestClient):
