...
from matchmaking.web_socket import Gs2MatchmakingWebSocketClient
import private.matchmaking.request as request_model
import private.matchmaking.result as result_model


class Gs2MatchmakingPrivateWebSocketClient(Gs2MatchmakingWebSocketClient):
