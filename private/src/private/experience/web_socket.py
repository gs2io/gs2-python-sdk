...
from experience.web_socket import Gs2ExperienceWebSocketClient
import private.experience.request as request_model
import private.experience.result as result_model


class Gs2ExperiencePrivateWebSocketClient(Gs2ExperienceWebSocketClient):
    ...
    def _describe_statuses_by_owner_id_and_user_id(
        ...
        body = self._create_metadata(
            service=self.SERVICE,
            component='status',
            function='describeStatusesByOwnerIdAndUserId',
            request_id=request_id,
            private=True,
        )
