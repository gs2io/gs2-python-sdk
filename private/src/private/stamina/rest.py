...
from stamina.rest import Gs2StaminaRestClient
from core.model import Gs2Constant
import private.stamina.request as request_model
import private.stamina.result as result_model


class Gs2StaminaPrivateRestClient(Gs2StaminaRestClient):
