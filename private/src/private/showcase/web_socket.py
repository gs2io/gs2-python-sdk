...
from showcase.web_socket import Gs2ShowcaseWebSocketClient
import private.showcase.request as request_model
import private.showcase.result as result_model


class Gs2ShowcasePrivateWebSocketClient(Gs2ShowcaseWebSocketClient):
