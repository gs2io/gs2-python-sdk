...
from money.web_socket import Gs2MoneyWebSocketClient
import private.money.request as request_model
import private.money.result as result_model


class Gs2MoneyPrivateWebSocketClient(Gs2MoneyWebSocketClient):
