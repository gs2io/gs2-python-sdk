...
from friend.rest import Gs2FriendRestClient
from core.model import Gs2Constant
import private.friend.request as request_model
import private.friend.result as result_model


class Gs2FriendPrivateRestClient(Gs2FriendRestClient):
