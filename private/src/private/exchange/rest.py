...
from exchange.rest import Gs2ExchangeRestClient
from core.model import Gs2Constant
import private.exchange.request as request_model
import private.exchange.result as result_model


class Gs2ExchangePrivateRestClient(Gs2ExchangeRestClient):
    ...
    def _describe_namespaces_by_owner_id(
        ...
        ) + "/system/{ownerId}/exchange".format(
