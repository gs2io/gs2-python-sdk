...
from log.web_socket import Gs2LogWebSocketClient
import private.log.request as request_model
import private.log.result as result_model


class Gs2LogPrivateWebSocketClient(Gs2LogWebSocketClient):
