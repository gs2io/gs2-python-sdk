...
from inbox.rest import Gs2InboxRestClient
from core.model import Gs2Constant
import private.inbox.request as request_model
import private.inbox.result as result_model


class Gs2InboxPrivateRestClient(Gs2InboxRestClient):
