...
from inventory.rest import Gs2InventoryRestClient
from core.model import Gs2Constant
import private.inventory.request as request_model
import private.inventory.result as result_model


class Gs2InventoryPrivateRestClient(Gs2InventoryRestClient):
    ...
    def _describe_namespaces_by_owner_id(
        ...
        ) + "/system/{ownerId}/namespace".format(
