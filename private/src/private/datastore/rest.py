...
from datastore.rest import Gs2DatastoreRestClient
from core.model import Gs2Constant
import private.datastore.request as request_model
import private.datastore.result as result_model


class Gs2DatastorePrivateRestClient(Gs2DatastoreRestClient):
    ...
    def _describe_namespaces_by_owner_id(
        ...
        ) + "/system/{ownerId}/datastore".format(
