...
from distributor import Gs2DistributorRestClient, DistributorModelMaster, request
from distributor.domain.cache.distributor_model_master import DistributorModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeDistributorModelMastersIterator:
    ...
    _last: bool
    _result: List[DistributorModelMaster]
    ...
    def _load(
        ...
        r = self._client.describe_distributor_model_masters(
        ...
        for item in r.items:
            self._distributor_model_master_cache.update(item)
    ...
    def __next__(self) -> DistributorModelMaster:
