...
from identifier import Gs2IdentifierRestClient, Identifier, request
from identifier.domain.cache.identifier import IdentifierDomainCache
from core.domain.access_token import AccessToken


class DescribeIdentifiersIterator:
    ...
    def _load(
        ...
        r = self._client.describe_identifiers(
        ...
        for item in r.items:
            self._identifier_cache.update(item)
