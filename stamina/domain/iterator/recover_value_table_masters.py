...
from stamina import Gs2StaminaRestClient, RecoverValueTableMaster, request
from stamina.domain.cache.recover_value_table_master import RecoverValueTableMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeRecoverValueTableMastersIterator:
    ...
    _last: bool
    _result: List[RecoverValueTableMaster]
    ...
    def _load(
        ...
        r = self._client.describe_recover_value_table_masters(
        ...
        for item in r.items:
            self._recover_value_table_master_cache.update(item)
    ...
    def __next__(self) -> RecoverValueTableMaster:
