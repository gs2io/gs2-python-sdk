...
from stamina import Gs2StaminaRestClient, StaminaModelMaster, request
from stamina.domain.cache.stamina_model_master import StaminaModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeStaminaModelMastersIterator:
    ...
    _last: bool
    _result: List[StaminaModelMaster]
    ...
    def _load(
        ...
        r = self._client.describe_stamina_model_masters(
        ...
        for item in r.items:
            self._stamina_model_master_cache.update(item)
    ...
    def __next__(self) -> StaminaModelMaster:
