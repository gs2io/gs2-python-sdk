...
from stamina import Gs2StaminaRestClient, RecoverIntervalTableMaster, request
from stamina.domain.cache.recover_interval_table_master import RecoverIntervalTableMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeRecoverIntervalTableMastersIterator:
    ...
    _last: bool
    _result: List[RecoverIntervalTableMaster]

    fetch_size: Optional[int]

    def __init__(
        self,
        recover_interval_table_master_cache: RecoverIntervalTableMasterDomainCache,
        client: Gs2StaminaRestClient,
        namespace_name: str,
    ):
        self._recover_interval_table_master_cache = recover_interval_table_master_cache
        self._client = client
    ...
    def _load(
        ...
        r = self._client.describe_recover_interval_table_masters(
        ...
        for item in r.items:
            self._recover_interval_table_master_cache.update(item)
    ...
    def __next__(self) -> RecoverIntervalTableMaster:
