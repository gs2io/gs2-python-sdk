...
from mission import Gs2MissionRestClient, CounterModelMaster, request
from mission.domain.cache.counter_model_master import CounterModelMasterDomainCache
from core.domain.access_token import AccessToken


class DescribeCounterModelMastersIterator:
    ...
    _last: bool
    _result: List[CounterModelMaster]
    ...
    def _load(
        ...
        r = self._client.describe_counter_model_masters(
        ...
        for item in r.items:
            self._counter_model_master_cache.update(item)
    ...
    def __next__(self) -> CounterModelMaster:
